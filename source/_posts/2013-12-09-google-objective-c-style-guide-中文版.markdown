...
<ul>
	...
	<li><a href="http://www.iwangke.me/objc-style-guide/#override_designated_initializer">重写指定的初始化器</a></li>
...
<p>总结：每个@标签应该有独立的一行，在@与{}之间需要有一个空格。@catch与被捕捉到的异常对象的声明之间也要有一个空格。</p>
