...
[维基百科](http://www.baidu.com)提供了转换 RGB 到 Lab 色彩空间的算法。写成方法之后如下所示：
...
>[Nan]:这个是系统回调函数，在这边提供依赖的关系，SDK会建立依赖关系链；比如color->redComponent->lComponent,当lComponent改变时，最终会影响到color。
